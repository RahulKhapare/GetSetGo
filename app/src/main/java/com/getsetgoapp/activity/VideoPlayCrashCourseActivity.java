...
public class VideoPlayCrashCourseActivity extends AppCompatActivity implements Player.EventListener, VideoCourseQualityAdapter.onClick {

    ActivityVideoPlayNewBinding activityVideoPlayBinding;
    SimpleExoPlayer exoPlayer;
    private ImageView imgFullScreen;
    private ImageView imgQuality;
    private VideoPlayCrashCourseActivity activity = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playVideo(CrashCourseDetailFragment.videoPlayPath);
    ...
    private void playVideo(String url){
        ...
        CrashCourseDetailFragment.videoPlayPath = url;
    ...
    private void onClick(){
        ...
        imgQuality.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Click.preventTwoClick(v);
                if (CrashCourseDetailFragment.videoUrlModelList!=null && !CrashCourseDetailFragment.videoUrlModelList.isEmpty()){
                    qualityUrlDialog(CrashCourseDetailFragment.videoUrlModelList);
                }
            }
        });
    ...
    private void qualityUrlDialog(List<VideoUrlModel> videoUrlModelList){
        ...
        VideoCourseQualityAdapter adapter = new VideoCourseQualityAdapter(activity,videoUrlModelList,CrashCourseDetailFragment.lastSelectedPosition,4);
...
//        dialog.getWindow().setLayout(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT);
    ...
    public void qualityClick(VideoUrlModel model,int position) {
        ...
        if (exoPlayer!=null){
            CrashCourseDetailFragment.lastSelectedPosition = position;
            CrashCourseDetailFragment.lastVideoPosition = exoPlayer.getCurrentPosition();
            exoPlayer.release();
            exoPlayer = null;
        }
